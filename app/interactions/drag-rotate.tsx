...
export class DragRotate extends React.Component<any, any> {
  render() {
    return (
      <div>
        <p>This example have disabled default <code>DragRotate</code> interaction, but it implements one that force you to use <code>CTRL + Drag</code> to rotate the map!</p>
